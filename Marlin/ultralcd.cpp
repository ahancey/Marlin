...
static void lcd_control_motion_menu()
{
    ...
    MENU_ITEM_EDIT(float3, MSG_NOZZLE2_OFFSET_X, &extruder_offset[X_AXIS][tmp_extruder], 0.00, 10);
    MENU_ITEM_EDIT(float3, MSG_NOZZLE2_OFFSET_Y, &extruder_offset[Y_AXIS][tmp_extruder], 0.00, 10);
